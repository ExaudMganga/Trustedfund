    ...
    <?php if(isset($_GET['message']) && $_GET["message"] === "0"):?>
      ...
      <div class="tables">
        ...
        <a href="#" class="btn" onclick="open_update_form()"><i class="uil uil-plus-circle"></i></i>Update</a>
          ...
          <h3 >Loan amount: <?php echo number_format($customer_showdata['fund_amount']);?>/=</h3>
          <h3 class="t-amount">Total Amount Returned: <?php echo number_format($total_data['total_return_amount']);?>/=</h3>
        </div>
          ...
          <tbody>
            ...
            while($customer_detail = mysqli_fetch_assoc($result_detail)){ 
              ...
              <td><b>
                ...
                <a href="edit_customer_view.php?dc_editid=<?php echo $customer_detail['dc_id'];?>" class="edit"><i class="uil uil-edit-alt"></i>Edit</a>
        ...
        <div class="pagination">
          <a href="#">&laquo;</a>
          <a class="active" href="view.php?viewid=<?php echo $viewid;?>">1</a>
          <a href="view.php?viewid=<?php echo $viewid;?>&page_no=2">2</a>
          <a href="view.php?viewid=<?php echo $viewid;?>&page_no=3">3</a>
          <a href="view.php?viewid=<?php echo $viewid;?>&page_no=4">4</a>
          <a href="view.php?viewid=<?php echo $viewid;?>&page_no=5">5</a>
          <a href="#">&raquo;</a>
        </div>
      </div>
    </div>    
