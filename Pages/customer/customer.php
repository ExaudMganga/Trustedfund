    ...
    <nav>
      <div class="menu-list">
        <ul>
          ...
          <li><a href="#"><i class="uil uil-users-alt"></i>Customer</a></li>
      ...
      <div class="tables">
        ...
        <table>
          ...
          <?php 
            ...
            <td><?php echo number_format($form_data['return_amount']);?>/=</td>
              <td>active</td>
              <td><b>
        ...
        <div class="pagination">
          <a href="#">&laquo;</a>
          <a class="active" href="customer.php">1</a>
          <a href="customer.php?page_no=2">2</a>
          <a href="customer.php?page_no=3">3</a>
          <a href="customer.php?page_no=4">4</a>
          <a href="customer.php?page_no=5">5</a>
          <a href="#">&raquo;</a>
        </div>
      </div>
    </div>    
